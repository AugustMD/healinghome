    ...
    <div class="col-md-2">
      <div class="sidebar content-box" style="display: block;">
		  ...
		  <div class="col-md-10">
                ...
                <div class="content">
                <h4 class="title"><i style="margin-right:10px; margin-bottom:20px;" class="glyphicon glyphicon-tree-conifer"></i> 주변관광지 목록</h4>
                <table class="table table-hover">
                  <thead class="thead-inverse">
                      ...
                      <th align="center" class="request_content" style="width: 22;">문의전화</th>
                      <th align="center" class="request_content" style="width: 22%;">홈페이지</th>
                  </thead>
                  <tbody>
                    <?php
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        echo '<tr onclick=location.href="./modify-surrounding.php?tid='.$row[tid].'">';
                        echo '  <td align="center">'.$row[name].'</td>';
                        echo '  <td align="center">'.$row[address].'</td>';
                        echo '  <td align="center">'.$row[number].'</td>';
                        echo '  <td align="center">'.$row[homepage].'</td>';
                        echo '</tr>';
                      }
                    ?>
                    </tbody>
