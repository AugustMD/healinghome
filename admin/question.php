              ...
              <div class="left-side-margin">
                ...
                <div class="left-side-margin2">
                      ...
                      <div>
                        ...
                        <?php
                          if($_GET['board'] == "land") {
                            ...
                            $sql = "SELECT * FROM customer WHERE qid='".$_GET['qid']."'";
                          }
                  ...
                  <div class="content">
                      ...
                      <?php
                      if($row['attachment'] != '') {
                        $_substr = substr($row[attachment], 0, 8);
                        if($_GET['board'] == "land") {
                          if($_substr != 'uploads/') {
                            echo'<img src="'.$row['attachment'].'" style="width:300px;">';
                          }
                          else {
                            echo'<img src="../landlord/'.$row['attachment'].'" style="width:300px;">';
                          }
                        }
                        else {
                          if($_substr != 'uploads/') {
                        ...
                        <div class="comment_content">
                          ...
                          <?php
                            if($_GET['board'] == "land") {
                              ...
                              $sql3 = "SELECT * FROM customer_comment WHERE qid='".$_GET['qid']."' ";
                              $result3 = mysqli_query($conn, $sql3);
                              while($row3 = mysqli_fetch_assoc($result3)) {
                                $sql4 = "SELECT name FROM user_info where id='".$row3[id]."'";
                                $result4 = mysqli_query($conn, $sql4);
