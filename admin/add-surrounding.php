    ...
    <div class="col-md-2">
      <div class="sidebar content-box" style="display: block;">
		  ...
		  <div class="col-md-10 land-info">
                ...
                <h4 class="title"><i style="margin-right:10px; margin-bottom:20px;" class="glyphicon glyphicon-tree-conifer"></i> 주변관광지 등록</h4>
                <table class="table table-reflow">
                    <tbody>
                      <form action="tourist_spot_upload.php" method="post" id="target" enctype="multipart/form-data">
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="container-fluid tdContainer" style="display:flex">
                                      <textarea class="form-control" name="introduction" id="introduction" rows="15" style="font-size:13px;"></textarea>
                                  </div>
                              </td>
                          </tr>
                          <tr>
                ...
                <a href="#"><button type="button" class="col-md-offset-3 col-md-6 btn btn-success" onclick="submit()"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&emsp;등록</button></a>
		  				</div>
		  			</div>
      ...
      <script>
          function submit() {
              if($("#tname").val() != '' && $("#sample6_address").val() != '' && $("#qnumber").val() != '' && $("#homepage").val() != '' && $("#introduction").val() != '' && $("#list").children("ul").children("li").children("strong").text() != '') {
                $("#target").submit();
              }
              else {
                alert("모든 항목을 입력해주세요.");
