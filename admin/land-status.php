    ...
    <div class="col-md-2">
      <div class="sidebar content-box" style="display: block;">
		  ...
		  <div class="col-md-10">
                ...
                <div class="content">
                <h4 class="title"><i class="glyphicon glyphicon-th-list" style="margin-right:10px; margin-bottom:20px;"></i>토지 신청 현황</h4>
                <table class="table table-hover">
                  <thead class="thead-inverse">
                      <th align="center" class="request_content" style="width: 10%;">이름</th>
                      <th align="center" class="request_content" style="width: *;">지역</th>
                      <th align="center" class="request_content" style="width: 15%;">면적</th>
                      <th align="center" class="request_content" style="width: 15%;">가격</th>
                      <th align="center" class="request_content" style="width: 20%;">기간</th>
                      <th align="center" class="request_content" style="width: 10%;">진행상황</th>
                  </thead>
                  <tbody>
                    <?php
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<tr onclick=location.href="./land-info.php?lid='.$row[lid].'">';
                        echo '  <td align="center">'.$row2[name].'</td>';
                        echo '  <td align="center">'.$row[address].'</td>';
                        echo '  <td align="center">'.number_format($row[area]).'m<sup>2</sup></td>';
                        echo '  <td align="center">'.number_format($row[price]).'원</td>';
                        echo '  <td align="center">'.$row[start].' ~ '.$row[end].'</td>';
                        echo '  <td align="center" id="status'.$i.'">'.$row[progress].'</td>';
                        $i++;
                      }
                    ?>
                    </tbody>
